...
!(function (t, n) {
            ...
            return (
                u && c
                    ...
                    : u
                      ...
                      : c &&
                        (g(c, i, f, o, a), g(c, f, i, o, a), g(c, i, f, o, a)),
                n
            );
        };
    }
    ...
    function ct(t, n, e = o) {
        if (!isNaN((n = +n))) {
            if (
                ((r = Float64Array.from(t, (n, r) => o(e(t[r], r, t)))), n <= 0)
            )
                return et(r);
            if (n >= 1) return tt(r);
            var r,
    ...
    Vn.prototype = Wn.prototype = {
        ...
        property: function (t, n) {
            return arguments.length > 1
                ? this.each(
                      (null == n ? bn : "function" == typeof n ? xn : mn)(t, n),
                  )
                : this.node()[t];
        },
        ...
        text: function (t) {
            return arguments.length
                ? this.each(
                      null == t ? Cn : ("function" == typeof t ? zn : Pn)(t),
                  )
        ...
        html: function (t) {
            return arguments.length
                ? this.each(
                      null == t ? $n : ("function" == typeof t ? Rn : Dn)(t),
                  )
                : this.node().innerHTML;
        },
        raise: function () {
    ...
    function or(t) {
        ...
        return (
            r === i && i === o
                ? (n = e = a)
                : ((n = cr(
                      (0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / Qe,
                  )),
                  (e = cr(
                      (0.0139322 * r + 0.0971045 * i + 0.7141733 * o) / tr,
                  ))),
    ...
    let Ua = class {
                ...
                if (Math.abs(s * u - c * f) > Ra && i) {
                    let h = e - o,
                        ...
                        _ =
                            i *
                            Math.tan(
                                ($a - Math.acos((p + l - g) / (2 * y * v))) / 2,
                            ),
                        b = _ / v,
                        m = _ / y;
                    (Math.abs(b - 1) > Ra &&
                        this._append`L${t + b * f},${n + b * s}`,
                        this
        ...
        arc(t, n, e, r, i, o) {
            ...
            (null === this._x1
                ? this._append`M${c},${f}`
                : (Math.abs(this._x1 - c) > Ra ||
                      Math.abs(this._y1 - f) > Ra) &&
                  this._append`L${c},${f}`,
                e &&
                    (l < 0 && (l = (l % Da) + Da),
                    l > Fa
            ...
            if (
                ...
                if (t) {
                    ...
                    (c.quadraticCurveTo(0, 0, v * Ta(_), v * Aa(_)),
                        c.arc(0, 0, v, _, b));
            if (
                (c.quadraticCurveTo(0, 0, p * Ta(g), p * Aa(g)),
                c.closePath(),
                f)
            )
    ...
    function cu(t, n, e, r) {
        const i = r - n,
            o = e - n,
            a =
                isFinite(i) || isFinite(o)
                    ? i / o
                    : Math.sign(i) / Math.sign(o);
    ...
    class Ru {
        ...
        arc(t, n, e) {
            ...
            (null === this._x1
                ? (this._ += `M${r},${i}`)
                : (Math.abs(this._x1 - r) > Du ||
                      Math.abs(this._y1 - i) > Du) &&
                  (this._ += "L" + r + "," + i),
                e &&
        ...
        _clipSegment(t, n, e, r, i, o) {
            ...
            for (a && ([t, n, e, r, i, o] = [e, r, t, n, o, i]); ;) {
                ...
                let u,
                    ...
                    f = i || o;
                (8 & f
                    ? ((u = t + ((e - t) * (this.ymax - n)) / (r - n)),
                      (c = this.ymax))
                    : 4 & f
                      ? ((u = t + ((e - t) * (this.ymin - n)) / (r - n)),
                        (c = this.ymin))
                      : 2 & f
            ...
            if (
                ...
                for (
                    ...
                    ((n = i),
                        ...
                        n &&
                            i &&
                            ((e = this._edge(t, n, i, u, e)), (r = u.length)));
            else
                this.contains(
                    t,
                    (this.xmin + this.xmax) / 2,
    ...
    function Ju(t) {
        ...
        function r(t, n) {
            ...
            for (
                t.charCodeAt(o - 1) === Gu && --o,
                    t.charCodeAt(o - 1) === Vu && --o;
                (r = s()) !== Hu;
            ) {
    ...
    ((Fc.copy = function () {
        ...
        (Fc.visitAfter = function (t) {
            ...
            for (
                this._root &&
                e.push(
                    new Cc(this._root, this._x0, this._y0, this._x1, this._y1),
                );
                (n = e.pop());
            ) {
                var i = n.node;
    ...
    var ef = {
        ...
        s: function (t, n) {
            ...
            var r = e[0],
                ...
                o =
                    i -
                    (Kc = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) +
                    1,
                a = r.length;
            return o === a
                ? r
        ...
        function l(t) {
            ...
            function M(t) {
                ...
                switch (
                    (g &&
                        d &&
                        ((t = r(S + t, S.length ? p - M.length : 1 / 0)),
                        (S = "")),
                    e)
                ) {
                    case "<":
    ...
    function lf(t, n) {
        return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(Zc(n) / 3))) -
                Zc(Math.abs(t)),
        );
    }
    function hf(t, n) {
    ...
    function cl(t) {
        return function (n, e) {
            return (
                xf((n += t)) > gf && (n -= Math.round(n / _f) * _f),
                [n, e]
            );
        };
    }
        ...
        return function (a) {
            var c,
                ...
                x = {
                    ...
                    lineEnd: function () {
                        c &&
                            (M(l, h), d && y && m.rejoin(), c.push(m.result()));
    ...
    const Zg = Wg.range,
        ...
        py = Vg(
            ...
            (t, n) =>
                (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Qg) /
                ty,
            (t) => t.getDate() - 1,
        ),
        gy = py.range,
    ...
    ((Tw.prototype = ww.prototype),
        ...
        (t.contourDensity = function () {
            ...
            return (
                (d.contours = function (t) {
                    ...
                    return (
                        Object.defineProperty(i, "max", {get: () => J(n) / r}),
                        i
                    );
                }),
                (d.x = function (n) {
        ...
        (t.drag = function () {
            ...
            function d(a, u) {
                if (!r && i.call(this, a, u)) {
                    ...
                    c &&
                        (Zn(a.view)
                            .on("mousemove.drag", p, re)
                            .on("mouseup.drag", g, re),
                        ae(a.view),
                        ie(a),
                        (e = !1),
                        (t = a.clientX),
                    ...
                    for (a = 0, i = new Array(f); a < s; ++a)
                        (((c = t[a]).index = a),
                            "object" != typeof c.source &&
                                (c.source = Yc(l, c.source)),
                            "object" != typeof c.target &&
                                (c.target = Yc(l, c.target)),
        ...
        (t.geoCircle = function () {
            ...
            return (
                (a.center = function (t) {
                    return arguments.length
                        ? ((e =
                              "function" == typeof t ? t : il([+t[0], +t[1]])),
                          a)
                        : e;
                }),
                (a.radius = function (t) {
        ...
        (t.pie = function () {
            ...
            function a(a) {
                var u,
                    ...
                    v = Math.min(
                        Em,
                        Math.max(-Em, i.apply(this, arguments) - y),
                    ),
        ...
        (t.stack = function () {
            ...
            return (
                (i.keys = function (n) {
                    return arguments.length
                        ? ((t = "function" == typeof n ? n : ym(Array.from(n))),
                          i)
                        : t;
                }),
                (i.value = function (t) {
        ...
        (t.stratify = function () {
            ...
            function r(r) {
                ...
                if (null != t) {
                    ...
                    for (const t of e)
                        i.has(t) ||
                            (i.add(t), n.push(t), e.push(Pp(t)), h.push(Np));
                    ((d = (t, e) => n[e]), (p = (t, n) => e[n]));
                }
        ...
        (t.thresholdFreedmanDiaconis = function (t, n, e) {
            ...
            return r && i
                ? Math.ceil((e - n) / (2 * i * Math.pow(r, -1 / 3)))
                : 1;
        }),
        (t.thresholdScott = function (t, n, e) {
            const r = v(t),
                i = w(t);
            return r && i
                ? Math.ceil(((e - n) * Math.cbrt(r)) / (3.49 * i))
                : 1;
        }),
        ...
        (t.tree = function () {
            ...
            function i(i) {
                var c = (function (t) {
                    for (
                        var n, e, r, i, o, a = new Up(t, 0), u = [a];
                        (n = u.pop());
                    )
                        if ((r = n._.children))
                            for (
                ...
                if (r.apply(this, arguments)) {
                    var e = w(this, n).event(t),
                        ...
                        u = Math.max(
                            ...
                            Math.min(
                                c[1],
                                i.k * Math.pow(2, a.apply(this, arguments)),
                            ),
                        ),
                        s = ne(t);
                    if (e.wheel)
